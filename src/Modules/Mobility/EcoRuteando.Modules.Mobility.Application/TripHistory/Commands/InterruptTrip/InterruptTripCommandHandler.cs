...
public sealed class InterruptTripCommandHandler
    : IRequestHandler<InterruptTripCommand>
{
    private readonly IRouteUsageRepository _routeUsageRepository;
    private readonly IMobilityUnitOfWork _unitOfWork;

    public InterruptTripCommandHandler(
